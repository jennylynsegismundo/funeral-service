            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="<?php echo base_url();?>template/img-profile rounded-circle"
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                      ...
                      <div class="card-body">
                        <form action="<?=base_url('funeralservices/store')?>" method="post">
                          <div class="form-group">
                            <label for="servicename">Service Name</label>
                            <input type="text" name="service_name" class="form-control" id="servicename">
                            <small><?= form_error('service_name') ?></small>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            <label for="associated_products">Associated Products</label>
                            <input type="text" name="associated_products" class="form-control">
                            <small><?=form_error('associated_products'); ?></small>
                          </div>
                          <div class="form-group">
                            <button type="submit" class="btn btn-info addbtn">Add</button>
                          </div>
                        </form>
                      </div>
                    </div>
