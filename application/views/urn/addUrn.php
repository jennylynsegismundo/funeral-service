      ...
      <div class="container-fluid">
        <div class="card shadow mb-4">
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Add Urn</h6>
          </div>
          <div class="card-body">
            <form action="<?=base_url('stored_urn')?>" method="post">

              <div class="form-group">
                <label for="">Urn Name</label>
                <input type="text" name="urn_name" class="form-control">
              ...
              <div class="form-group">
                ...
                <input type="text" name="urn_price" class="form-control">
