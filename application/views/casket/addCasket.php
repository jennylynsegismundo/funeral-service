      ...
      <div class="container-fluid">
        <div class="card shadow mb-4">
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Add Casket</h6>
          </div>
          <div class="card-body">
            <form action="<?=base_url('storedcasket')?>" method="post">
              <div class="form-group">
                <label for="">Casket Name</label>
                <input type="text" name="casket_name" class="form-control">
              ...
              <div class="form-group">
                ...
                <input type="text" name="casket_price" class="form-control">
