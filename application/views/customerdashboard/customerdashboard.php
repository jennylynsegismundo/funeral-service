...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('Customer_Dashboard')?>">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?=base_url('ViewScheduleService')?>">
          <i class="fas fa-fw fa-calendar"></i><span>Service Schedule</span></a>
      </li>
      <!-- Divider -->
    ...
    <div id="content">
      ...
      <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
          <h1 class="h3 mb-0 text-gray-800">Service Available</h1>
        </div>
        <!-- Content Row -->
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="card shadow mb-4 bg-gray-200">
              <div class="card-header py-3">
                <?php if (isset($service->service_id)) : ?>
                  <h6 class="m-0 font-weight-bold text-primary"><?= $service->service_name; ?></h6>
                <?php elseif (isset($service->new_service_id)) : ?>
                  <h6 class="m-0 font-weight-bold text-primary"><?= $service->new_service_name; ?></h6>
                <?php endif; ?>
              </div>
              <div class="card-body">
                <p class="card-text text-gray-900">
                  ...
                  <?php elseif (isset($service->new_service_price)) : ?>
                    <?= number_format($service->new_service_price, 2); ?>
                  <?php endif; ?>
                </p>
                <p class="text-gray-900">
                  <?php if (isset($service->associated_products) && is_array($service->associated_products)) : ?>
                  <strong>Associated Products:</strong>
                  <ul>
                  <?php foreach ($service->associated_products as $product) : ?>
