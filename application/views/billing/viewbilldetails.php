      ...
      <div class="container-fluid">
        <div class="card shadow mb-4">
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Edit Casket</h6>
          </div>
          <div class="card-body">
            <div class="bill-header">
                <h1 class="">Bill for Tribute Service</h1>
                <hr>
            </div>

            <div class="customer-details">
                <div class="section-header">Customer Details:</div>
                <p><strong>Name:</strong> Jenny Lyn Segismundo</p>
                <p><strong>Contact Number:</strong> (+63) 9691632363</p>
                <p><strong>Address:</strong> Abuyog, Sorsogon City</p>
                <p><strong>Relationship to Deceased:</strong> Cousin</p>
            </div>

            <div class="deceased-details">
                <div class="section-header">Deceased Details:</div>
                <p><strong>Name:</strong> John Doe</p>
                <p><strong>Gender:</strong> Male</p>
                <p><strong>Date of Birth:</strong> 04/23/1991</p>
                <p><strong>Date of Death:</strong> 01/07/2024</p>
                <p><strong>Age:</strong> 33</p>
            </div>

            <div class="schedule-details">
                <div class="section-header">Schedule Details:</div>
                <p><strong>Title:</strong> Tribute for John Doe</p>
                <p><strong>Start Date:</strong> 01/08/2024</p>
                <p><strong>End Date:</strong> 01/15/2024</p>
            </div>

            <div class="services">
                <div class="section-header">Selected Services:</div>
                <ul>
                    <li>Tribute Service - Php 10,000</li>
                    <li>Flower Arrangement - Included</li>
                    <li>Farewell T-shirt - Included</li>
                    <li>Casket: Dominique Casket - Php 25,000</li>
                </ul>
            </div>

            <div class="total-amount">
                <hr>
                <p><strong>Total Amount Due:</strong> Php 35,000</p>
            </div>
          </div>
        </div>
      </div>
