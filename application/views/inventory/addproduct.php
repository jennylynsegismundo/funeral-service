    ...
    <div id="content">
      ...
      <div class="container-fluid">
        <div class="card shadow mb-4">
          ...
          <div class="card-body">
            <form action="<?= base_url('StoreAddProduct') ?>" method="post">
              <div class="form-group">
                <label for="">Product Name</label>
                <input type="text" name="product_id" class="form-control">
                <small class="text-danger"><?= form_error('product_id')?></small>
              </div>
              <div class="form-group">
                ...
                <small class="text-danger"><?= form_error('')?></small>
              </div>
              <div class="form-group">
                <label for="">Quantity in Stock</label>
                <input type="number" name="inventory_stock" class="form-control">
                <small class="text-danger"><?= form_error('')?></small>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input class="form-control" type="date" name="date_restock" value="">
              </div>
