    ...
    <div id="content">
      ...
      <div class="container-fluid">
        <div class="card shadow mb-4">
          ...
          <div class="card-body">
            <form action="<?=base_url('updateSchedule/'. $schedule->sched_id)?>" method="post">
              <div class="form-group">
                <label for="schedule_name">Schedule Name</label>
                <input type="text" name="schedule_name" class="form-control">
                <small class="text-danger"><?= form_error('schedule_name')?></small>
              </div>
              ...
              <div class="form-group">
                <label for="">Decesead Name</label>
                <input type="text" name="deceased_name" value="<?= $schedule->deceased_name ?>" class="form-control" readonly>
                <small class="text-danger"><?= form_error('deceased_name')?>*The Deceased Name are fixed it will not change the person name.</small>
              </div>

              <hr>
              <h6>Date of Arrangement</h6>
              <div class="form-group">
                <label for="">Start Date</label>
                <input type="date" name="start_date" value="<?= $schedule->start_date ?>" class="form-control">
                <small><?= form_error('start_date')?></small>
              </div>

              <div class="form-group">
                <label for="">End Date</label>
                <input type="date" name="end_date" value="<?= $schedule->end_date ?>" class="form-control">
                <small><?= form_error('end_date')?></small>
              </div>

              <hr>
              <div class="form-group">
                <label for="">Location</label>
                <select class="form-control" name="location" readonly>
                  <option style="font-style: italic;">--please choose location--</option>
                  <option value="chapel" <?php echo ($schedule->location === 'chapel') ? 'selected' : ''; ?>>Chapel</option>
                  <option value="house" <?php echo ($schedule->location === 'house') ? 'selected' : ''; ?>>House</option>
                </select>
                <small class="text-danger">*The Location are fixed once it's choosen.</small>
              </div>
