      ...
      <div class="container-fluid">
        <div class="card shadow mb-4">
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Edit Customer Account</h6>
          </div>
          <div class="card-body">
            <form action="<?=base_url('UpdateCustomerAccount/'. $edit_account->user_id)?>" method="post">
              <div class="form-group">
                <label for="">Customer Name</label>
                <input type="text" name="cust_name" value="<?= $edit_account->cust_name ?>" class="form-control">
                <small class="text-danger"><?= form_error('cust_name')?></small>
              </div>

              <div class="form-group">
                <label for="">Customer Contact Number</label>
                <input type="text" name="cust_cont_no" value="<?= $edit_account->cust_cont_no ?>" class="form-control">
                <small class="text-danger"><?= form_error('cust_cont_no')?></small>
              </div>

              <div class="form-group">
                <label for="">Customer Address</label>
                <input type="text" name="cust_address" value="<?= $edit_account->cust_address ?>" class="form-control">
                <small class="text-danger"><?= form_error('cust_address')?></small>
              </div>

              <div class="form-group">
                <label for="">Username</label>
                <input type="text" name="username" value="<?= $edit_account->username ?>" class="form-control">
                <small class="text-danger"><?= form_error('username')?></small>
              </div>

              <div class="form-group">
                <label for="">Email</label>
                <input type="email" name="email" value="<?= $edit_account->email ?>" class="form-control">
                <small class="text-danger"><?= form_error('email')?></small>
              </div>

              <div class="form-group">
                <label for="">Password</label>
                <input type="text" name="password" value="<?= $edit_account->password ?>" class="form-control">
