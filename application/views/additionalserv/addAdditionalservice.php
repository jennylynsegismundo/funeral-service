      ...
      <div class="container-fluid">
        <div class="card shadow mb-4">
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Add Additional Product</h6>
          </div>
          <div class="card-body">
            <form action="<?=base_url('stored_additional_service')?>" method="post">
              <div class="form-group">
                <label for="">Additional Product Type</label>
                <input type="text" name="additional_serv_type" class="form-control">
