...
<head>
    ...
    <title>Casket Product Available</title>
    ...
    <div id="content">
      ...
      <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
          <h1 class="h3 mb-0 text-gray-800">Casket Product Available</h1>
        </div>
        <!-- Content Row -->
        <div class="row">
          <?php foreach ($casket as $casket): ?>
          <div class="col-lg-6">
            <div class="card shadow mb-4 bg-gray-200">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary"><?= $casket->casket_name; ?></h6>
                </div>
                <div class="card-body">
                  <p class="card-text text-gray-900"><?= $casket->description; ?></p>
                  <p class="card-text text-gray-900"> <strong>PRICE:</strong> <?=number_format($casket->casket_price, 2); ?></p>
                </div>
            </div>
          </div>
          <?php endforeach; ?>
