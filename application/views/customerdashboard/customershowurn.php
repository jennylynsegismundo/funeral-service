...
<head>
    ...
    <title>Urn Product Available</title>
    ...
    <div id="content">
      ...
      <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
          <h1 class="h3 mb-0 text-gray-800">Urn Product Available</h1>
        </div>
        <!-- Content Row -->
        <div class="row">
          <?php foreach ($urn as $urn): ?>
          <div class="col-lg-6">
            <div class="card shadow mb-4 bg-gray-200">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary"><?= $urn->urn_name; ?></h6>
                </div>
                <div class="card-body">
                  <p class="card-text text-gray-900"><?= $urn->description; ?></p>
                  <p class="card-text text-gray-900"> <strong>PRICE:</strong> <?=number_format($urn->urn_price, 2); ?></p>
                </div>
            </div>
          </div>
          <?php endforeach; ?>
