    ...
    <div id="content">
      ...
      <div class="container-fluid">
        <div class="card shadow mb-4">
          ...
          <div class="card-body">
            <form action="<?=base_url('updatecasket/'. $casket->casket_id)?>" method="post">
              <div class="form-group">
                <label for="">Casket Name</label>
                <input type="text" name="casket_name" value="<?= $casket->casket_name ?>" class="form-control">
                <small class="text-danger"><?= form_error('casket_name')?></small>
              </div>

              <div class="form-group">
                <label for="">Casket Description</label>
                <input type="text" name="description" value="<?= $casket->description ?>" class="form-control">
                <small class="text-danger"><?= form_error('description')?></small>
              </div>

              <div class="form-group">
                <label for="">Casket Price</label>
                <input type="text" name="casket_price" value="<?= $casket->casket_price ?>" class="form-control">
                <small class="text-danger"><?= form_error('casket_price')?></small>
              </div>
