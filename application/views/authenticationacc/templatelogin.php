          ...
          <!--<div class="col-lg-6 d-none d-lg-block"></div>-->
            <div class="col-lg-12">
              <div class="p-5">
                ...
                <form class="user" method="post" autocomplete="off" action="<?=base_url('LoginAccount')?>">
                  <div class="form-group">
                    <input name="username" type="text" class="form-control form-control-user" id="name" aria-describedby="name" placeholder="Enter Username...">
                    <small class="font-italic text-danger"><?= form_error('username')?></small>
                  </div>
                  <div class="form-group">
