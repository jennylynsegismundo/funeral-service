      ...
      <div class="container-fluid">
        <div class="card shadow mb-4">
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Edit Urn</h6>
          </div>
          <div class="card-body">
            <form action="<?=base_url('update_urn/'. $urn->urn_id)?>" method="post">

              <div class="form-group">
                <label for="">Urn Name</label>
                <input type="text" name="urn_name" value="<?= $urn->urn_name ?>" class="form-control">
                <small class="text-danger"><?= form_error('urn_name')?></small>
              </div>

              <div class="form-group">
                <label for="">Urn Description</label>
                <input type="text" name="description" value="<?= $urn->description ?>" class="form-control">
                <small class="text-danger"><?= form_error('description')?></small>
              </div>

              <div class="form-group">
                <label for="">Urn Price</label>
                <input type="text" name="urn_price" value="<?= $urn->urn_price ?>" class="form-control">
                <small class="text-danger"><?= form_error('urn_price')?></small>
              </div>
