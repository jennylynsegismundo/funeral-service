    ...
    <div id="content">
      ...
      <div class="container-fluid">
        <div class="card shadow mb-4">
          ...
          <div class="card-body">
            <form action="<?=base_url('funeralservices/update/'. $services->service_id) ?>" method="post">
              <!---->
              <!--FOR SERVICE NAME-->
              ...
              <div class="form-group mt-2">
                  ...
                  <select class="form-control multiple-select" name="associated_products[]" multiple>
                    ...
                    <?php foreach ($all_products as $product) : ?>
                      <?php
                      // Check if the current product is associated with the service
                      $isSelected = false;
                      foreach ($additional_prods as $assoc_prod) {
                        if ($assoc_prod->Product_ID == $product->id) {
                          $isSelected = true;
                          break;
                        }
                      }
